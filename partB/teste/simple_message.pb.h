...
class SimpleMessage PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_simple_5fmessage_2eproto);
    return ::descriptor_table_simple_5fmessage_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
// optional int32 num = 1;
inline bool SimpleMessage::_internal_has_num() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool SimpleMessage::has_num() const {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SimpleMessage::_internal_num() const {
  return num_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 SimpleMessage::num() const {
  // @@protoc_insertion_point(field_get:SimpleMessage.num)
  return _internal_num();
}
inline void SimpleMessage::_internal_set_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  num_ = value;
}
inline void SimpleMessage::set_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_num(value);
  // @@protoc_insertion_point(field_set:SimpleMessage.num)
}
