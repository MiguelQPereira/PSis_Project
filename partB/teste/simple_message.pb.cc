...
static void InitDefaultsscc_info_SimpleMessage_simple_5fmessage_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SimpleMessage_simple_5fmessage_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SimpleMessage_simple_5fmessage_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_simple_5fmessage_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_simple_5fmessage_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_simple_5fmessage_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_simple_5fmessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::SimpleMessage, _has_bits_),
...
const char descriptor_table_protodef_simple_5fmessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024simple_message.proto\"\034\n\rSimpleMessage\022"
  "\013\n\003num\030\001 \001(\005"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_simple_5fmessage_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_simple_5fmessage_2eproto_sccs[1] = {
  &scc_info_SimpleMessage_simple_5fmessage_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_simple_5fmessage_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_simple_5fmessage_2eproto = {
  false, false, descriptor_table_protodef_simple_5fmessage_2eproto, "simple_message.proto", 52,
  &descriptor_table_simple_5fmessage_2eproto_once, descriptor_table_simple_5fmessage_2eproto_sccs, descriptor_table_simple_5fmessage_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_simple_5fmessage_2eproto::offsets,
  file_level_metadata_simple_5fmessage_2eproto, 1, file_level_enum_descriptors_simple_5fmessage_2eproto, file_level_service_descriptors_simple_5fmessage_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_simple_5fmessage_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_simple_5fmessage_2eproto)), true);
...
const SimpleMessage& SimpleMessage::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SimpleMessage_simple_5fmessage_2eproto.base);
