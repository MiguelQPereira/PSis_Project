...
// optional int32 num = 1;
inline bool HighScore::_internal_has_num() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool HighScore::has_num() const {
  return _internal_has_num();
}
inline void HighScore::clear_num() {
  num_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 HighScore::_internal_num() const {
  return num_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 HighScore::num() const {
  // @@protoc_insertion_point(field_get:HighScore.num)
  return _internal_num();
}
inline void HighScore::_internal_set_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  num_ = value;
}
inline void HighScore::set_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_num(value);
  // @@protoc_insertion_point(field_set:HighScore.num)
}
