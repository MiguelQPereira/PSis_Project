...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_high_5fscore_2eproto = {
  false, false, descriptor_table_protodef_high_5fscore_2eproto, "high_score.proto", 127,
...
HighScore::HighScore(const HighScore& from)
  ...
  ::memcpy(&pa_, &from.pa_,
    static_cast<size_t>(reinterpret_cast<char*>(&ph_) -
