...
const uint32_t TableStruct_high_5fscore_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::HighScore, _impl_.game_),
...
const ::_pbi::DescriptorTable descriptor_table_high_5fscore_2eproto = {
    false, false, 141, descriptor_table_protodef_high_5fscore_2eproto,
    "high_score.proto",
...
HighScore::HighScore(const HighScore& from)
  ...
  ::memcpy(&_impl_.pa_, &from._impl_.pa_,
    ...
    reinterpret_cast<char*>(&_impl_.pa_)) + sizeof(_impl_.game_));
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          _impl_.game_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* HighScore::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000100u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(9, this->_internal_game(), target);
  }
