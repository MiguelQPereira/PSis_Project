...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_high_5fscore_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::HighScore, game_),
  PROTOBUF_FIELD_OFFSET(::HighScore, pa_),
  PROTOBUF_FIELD_OFFSET(::HighScore, pb_),
  PROTOBUF_FIELD_OFFSET(::HighScore, pc_),
  PROTOBUF_FIELD_OFFSET(::HighScore, pd_),
  PROTOBUF_FIELD_OFFSET(::HighScore, pe_),
  PROTOBUF_FIELD_OFFSET(::HighScore, pf_),
  PROTOBUF_FIELD_OFFSET(::HighScore, pg_),
  PROTOBUF_FIELD_OFFSET(::HighScore, ph_),
  8,
  0,
  1,
  2,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_high_5fscore_2eproto = {
  false, false, descriptor_table_protodef_high_5fscore_2eproto, "high_score.proto", 141,
...
HighScore::HighScore(const HighScore& from)
  ...
  ::memcpy(&pa_, &from.pa_,
    ...
    reinterpret_cast<char*>(&pa_)) + sizeof(game_));
...
// @@protoc_insertion_point(message_clear_start:HighScore)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&pa_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&ph_) -
        reinterpret_cast<char*>(&pa_)) + sizeof(ph_));
  }
  game_ = 0;
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          pb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // optional int32 pC = 3;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          ...
          pd_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // optional int32 pE = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          pe_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // optional int32 pF = 6;
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ...
          pf_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // optional int32 pG = 7;
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          ...
          pg_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // optional int32 pH = 8;
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          ...
          ph_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 72)) {
          _Internal::set_has_game(&has_bits);
...
::PROTOBUF_NAMESPACE_ID::uint8* HighScore::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_pa(), target);
  }

  // optional int32 pB = 2;
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_pb(), target);
  }

  // optional int32 pC = 3;
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_pc(), target);
  }

  // optional int32 pD = 4;
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_pd(), target);
  }

  // optional int32 pE = 5;
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_pe(), target);
  }

  // optional int32 pF = 6;
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(6, this->_internal_pf(), target);
  }

  // optional int32 pG = 7;
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(7, this->_internal_pg(), target);
  }

  // optional int32 pH = 8;
  if (cached_has_bits & 0x00000080u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(8, this->_internal_ph(), target);
  }

  // optional int32 game = 9;
  if (cached_has_bits & 0x00000100u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(9, this->_internal_game(), target);
  }
...
void HighScore::InternalSwap(HighScore* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(HighScore, game_)
      + sizeof(HighScore::game_)
      - PROTOBUF_FIELD_OFFSET(HighScore, pa_)>(
          reinterpret_cast<char*>(&pa_),
          reinterpret_cast<char*>(&other->pa_));
}
